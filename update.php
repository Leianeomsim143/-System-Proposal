...
<?php
    if($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        if($_FILES['photo']['size'] > 0){
            ...
            $sql = "UPDATE food_library SET food_name ='$food_name', food_calories='$food_calories', exercise = '$exercise', food_carbohydrates='$food_carbohydrates', food_picture='$photo_path' WHERE food_id='$food_id'";
        } else{
            $sql = "UPDATE food_library SET food_name ='$food_name', food_calories='$food_calories', exercise ='$exercise',food_carbohydrates='$food_carbohydrates' WHERE food_id='$food_id'";
        }
